...
pub fn trim_counts(codec: CodecId, delay: Option<u32>, padding: Option<u32>, already_trimmed: bool) -> (u64, u64) {
    if already_trimmed || !trim_enabled(codec) {
        return (0, 0);
    }
    (u64::from(delay.unwrap_or(0)), u64::from(padding.unwrap_or(0)))
}
